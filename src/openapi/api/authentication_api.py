...
class AuthenticationApi:
    ...
    def authenticate(
        self,
        authenticate_input: AuthenticateInput,
        ...
        :param authenticate_input: (required)
        :type authenticate_input: AuthenticateInput
        ...
        _param = self._authenticate_serialize(
            authenticate_input=authenticate_input,
    ...
    def _authenticate_serialize(
        ...
        if authenticate_input is not None:
            _body_params = authenticate_input
