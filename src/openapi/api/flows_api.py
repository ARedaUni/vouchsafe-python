...
from typing_extensions import Annotated
from openapi.models.flow import Flow
...
class FlowsApi:
    ...
    def get_flow(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the flow to retrieve.")],
        ...
        :param id: The ID of the flow to retrieve. (required)
        :type id: str
